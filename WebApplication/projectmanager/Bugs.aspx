...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <div class="table table-borderless table-hover table-responsive">
            <asp:GridView ID="grvBugs" runat="server" AutoGenerateColumns="False" BorderWidth="0px" CssClass="col-sm-12" Style="margin: auto;" OnRowEditing="grvBugs_RowEditing" OnRowUpdating="grvBugs_OnRowUpdating" OnRowCancelingEdit="grvBugs_OnRowCancelingEdit" EnableViewState="False">
                <Columns>
                    ...
                    <asp:CommandField ShowEditButton="True" ControlStyle-CssClass="btn btn-secondary rounded-circle" EditText="<i aria-hidden='true' class='fas fa-pen'></i>">
                        <ControlStyle CssClass="btn btn-secondary rounded-circle" />
                        <HeaderStyle BackColor="#3498DB" ForeColor="White" />
                    </asp:CommandField>
